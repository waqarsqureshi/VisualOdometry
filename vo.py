...
print("GPS projection completed.")
...
print("Starting real-time Visual Odometry + Accelerometer + GPS fusion...")
            ...
            if E is not None:
                ...
                if frame_idx < len(gps_interp_x):
                    ...
                    if frame_idx > 0:
                        ...
                        if gps_jump_meters < 3.0:  # 3 meters threshold
                            y = z_gps - (H @ x)
                            S = H @ P @ H.T + R_kalman
    	...
    	break
    		...
    		while True:
		    	...
		    	if key2 == ord('p'):
		        	...
		        	print("Simulation interrupted during pause.")
		        	cap.release()
...
print(f"Average Error: {results_df['error_m'].mean():.2f} meters")
print(f"Max Error: {results_df['error_m'].max():.2f} meters")
